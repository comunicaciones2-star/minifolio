...
export const buttonBaseClass =
  "inline-flex items-center justify-center rounded-md px-6 py-3 text-sm font-semibold transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2";

export const primaryButtonClass = "bg-brand-accent text-brand-white shadow-soft hover:bg-[#1d4ed8]";

export const secondaryButtonClass =
  "border border-slate-300 bg-brand-white text-brand-primary hover:border-brand-accent/30 hover:bg-blue-50";
...
export function GhostButton({ children, className, ...props }: ActionButtonProps) {
  return (
    <button className={cn(buttonBaseClass, "px-3 py-2 text-brand-accent hover:bg-blue-50", className)} {...props}>
      {children}
    </button>
  );
}
